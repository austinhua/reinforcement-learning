...
export maxNumberOfEpisodes=64

hostname >> ROSfreePendulumSwingupExperiment$dKnown.$epsilonA.$epsilonB.$regularizer.$maxNumberOfEpisodes.$SGE_TASK_ID.out
./scripts/ROSfreePendulumSwingupExperiment.py $dKnown $epsilonA $epsilonB $regularizer $maxNumberOfEpisodes >> ROSfreePendulumSwingupExperiment$dKnown.$epsilonA.$epsilonB.$regularizer.$maxNumberOfEpisodes.$SGE_TASK_ID.out
